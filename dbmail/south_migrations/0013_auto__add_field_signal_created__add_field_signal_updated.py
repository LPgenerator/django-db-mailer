...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signal.created'
        db.add_column('dbmail_signal', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 28, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Signal.updated'
        db.add_column('dbmail_signal', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 7, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signal.created'
        db.delete_column('dbmail_signal', 'created')

        # Deleting field 'Signal.updated'
        db.delete_column('dbmail_signal', 'updated')

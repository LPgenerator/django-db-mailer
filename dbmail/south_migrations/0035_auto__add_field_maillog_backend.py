...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailLog.backend'
        db.add_column('dbmail_maillog', 'backend',
                      self.gf('django.db.models.fields.CharField')(default='mail', max_length=25, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailLog.backend'
        db.delete_column('dbmail_maillog', 'backend')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailBaseTemplate'
        db.create_table('dbmail_mailbasetemplate', (
        ...
        db.send_create_signal('dbmail', ['MailBaseTemplate'])

        # Adding field 'MailTemplate.base'
        db.add_column('dbmail_mailtemplate', 'base',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbmail.MailBaseTemplate'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MailBaseTemplate'
        db.delete_table('dbmail_mailbasetemplate')

        # Deleting field 'MailTemplate.base'
        db.delete_column('dbmail_mailtemplate', 'base_id')

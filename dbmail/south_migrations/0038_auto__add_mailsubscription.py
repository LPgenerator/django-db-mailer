...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailSubscription'
        db.create_table('dbmail_mailsubscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('backend', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('start_hour', self.gf('django.db.models.fields.CharField')(default='00:00', max_length=5)),
            ('end_hour', self.gf('django.db.models.fields.CharField')(default='23:59', max_length=5)),
            ('is_enabled', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True)),
            ('is_checked', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('defer_at_allowed_hours', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal('dbmail', ['MailSubscription'])


    def backwards(self, orm):
        # Deleting model 'MailSubscription'
        db.delete_table('dbmail_mailsubscription')

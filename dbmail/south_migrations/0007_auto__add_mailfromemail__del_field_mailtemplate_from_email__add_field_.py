...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailFromEmail'
        db.create_table('dbmail_mailfromemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal('dbmail', ['MailFromEmail'])
        ...
        db.add_column('dbmail_mailtemplate', 'from_mail',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbmail.MailFromEmail'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MailFromEmail'
        db.delete_table('dbmail_mailfromemail')
        ...
        db.delete_column('dbmail_mailtemplate', 'from_mail_id')
    ...
    models = {
        ...
        'dbmail.mailtemplate': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'from_mail': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dbmail.MailFromEmail']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

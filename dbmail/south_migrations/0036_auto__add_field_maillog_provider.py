...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailLog.provider'
        db.add_column('dbmail_maillog', 'provider',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=250, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailLog.provider'
        db.delete_column('dbmail_maillog', 'provider')

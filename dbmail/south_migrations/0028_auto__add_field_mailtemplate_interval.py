...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailTemplate.interval'
        db.add_column('dbmail_mailtemplate', 'interval',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailTemplate.interval'
        db.delete_column('dbmail_mailtemplate', 'interval')

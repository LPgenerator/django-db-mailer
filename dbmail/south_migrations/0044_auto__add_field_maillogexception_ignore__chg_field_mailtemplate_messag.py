...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailLogException.ignore'
        db.add_column('dbmail_maillogexception', 'ignore',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MailLogException.ignore'
        db.delete_column('dbmail_maillogexception', 'ignore')

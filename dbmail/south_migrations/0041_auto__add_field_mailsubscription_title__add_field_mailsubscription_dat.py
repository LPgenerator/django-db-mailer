...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailSubscription.title'
        db.add_column('dbmail_mailsubscription', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MailSubscription.data'
        db.add_column('dbmail_mailsubscription', 'data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailSubscription.title'
        db.delete_column('dbmail_mailsubscription', 'title')

        # Deleting field 'MailSubscription.data'
        db.delete_column('dbmail_mailsubscription', 'data')

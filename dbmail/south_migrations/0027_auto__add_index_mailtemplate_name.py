...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MailTemplate', fields ['name']
        db.create_index('dbmail_mailtemplate', ['name'])


    def backwards(self, orm):
        # Removing index on 'MailTemplate', fields ['name']
        db.delete_index('dbmail_mailtemplate', ['name'])

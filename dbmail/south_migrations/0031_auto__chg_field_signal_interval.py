...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Signal.interval'
        db.alter_column('dbmail_signal', 'interval', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Signal.interval'
        db.alter_column('dbmail_signal', 'interval', self.gf('django.db.models.fields.PositiveIntegerField')())

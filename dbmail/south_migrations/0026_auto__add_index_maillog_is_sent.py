...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MailLog', fields ['is_sent']
        db.create_index('dbmail_maillog', ['is_sent'])


    def backwards(self, orm):
        # Removing index on 'MailLog', fields ['is_sent']
        db.delete_index('dbmail_maillog', ['is_sent'])

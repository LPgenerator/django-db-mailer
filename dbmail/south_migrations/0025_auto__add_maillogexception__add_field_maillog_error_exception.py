...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailLogException'
        db.create_table('dbmail_maillogexception', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150)),
        ))
        db.send_create_signal('dbmail', ['MailLogException'])

        # Adding field 'MailLog.error_exception'
        db.add_column('dbmail_maillog', 'error_exception',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbmail.MailLogException'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MailLogException'
        db.delete_table('dbmail_maillogexception')

        # Deleting field 'MailLog.error_exception'
        db.delete_column('dbmail_maillog', 'error_exception_id')

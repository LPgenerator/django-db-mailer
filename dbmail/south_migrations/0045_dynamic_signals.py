...
from dbmail.defaults import _SIGNALS

class Migration(SchemaMigration):

    def forwards(self, orm):
        # Changing field 'Signal.signal'
        db.alter_column('dbmail_signal', 'signal', self.gf('django.db.models.fields.CharField')(max_length=255))
        for module_path, signal_name in _SIGNALS:
            orm.Signal.objects.filter(signal=signal_name).update(signal=module_path)

    def backwards(self, orm):
        # Changing field 'Signal.signal'
        db.alter_column('dbmail_signal', 'signal', self.gf('django.db.models.fields.CharField')(max_length=15))
        for module_path, signal_name in _SIGNALS:
            orm.Signal.objects.filter(signal=module_path).update(signal=signal_name)
    ...
    models = {
        ...
        'dbmail.maillogemail': {
            ...
            'email': ('django.db.models.fields.CharField', [], {'max_length': '350'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'dbmail.mailsubscription': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '350', 'db_index': 'True'}),
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '350', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'dbmail.mailtemplate': {
        ...
        'dbmail.signal': {
            ...
            'signal': ('django.db.models.fields.CharField', [], {'default': "'django.db.models.signals.post_save'", 'max_length': '255'}),
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dbmail.MailTemplate']"}),

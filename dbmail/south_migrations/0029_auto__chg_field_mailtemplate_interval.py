...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailTemplate.interval'
        db.alter_column('dbmail_mailtemplate', 'interval', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'MailTemplate.interval'
        db.alter_column('dbmail_mailtemplate', 'interval', self.gf('django.db.models.fields.PositiveIntegerField')())

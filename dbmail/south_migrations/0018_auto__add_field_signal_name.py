...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signal.name'
        db.add_column('dbmail_signal', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Signal', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signal.name'
        db.delete_column('dbmail_signal', 'name')
    ...
    models = {
        ...
        'dbmail.signal': {
            ...
            'rules': ('django.db.models.fields.TextField', [], {'default': "'{{ instance.email }}'"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailGroupEmail'
        db.create_table('dbmail_mailgroupemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbmail.MailGroup'])),
        ))
        db.send_create_signal('dbmail', ['MailGroupEmail'])

        # Adding model 'MailGroup'
        db.create_table('dbmail_mailgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal('dbmail', ['MailGroup'])


    def backwards(self, orm):
        # Deleting model 'MailGroupEmail'
        db.delete_table('dbmail_mailgroupemail')

        # Deleting model 'MailGroup'
        db.delete_table('dbmail_mailgroup')

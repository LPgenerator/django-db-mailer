...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('dbmail', ['Signal'])


    def backwards(self, orm):
        # Deleting model 'Signal'
        db.delete_table('dbmail_signal')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailTemplate.enable_log'
        db.add_column('dbmail_mailtemplate', 'enable_log',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailTemplate.enable_log'
        db.delete_column('dbmail_mailtemplate', 'enable_log')

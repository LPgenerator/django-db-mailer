...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailFromEmail.created'
        db.add_column('dbmail_mailfromemail', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 14, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'MailFromEmail.updated'
        db.add_column('dbmail_mailfromemail', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 7, 14, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailFromEmail.created'
        db.delete_column('dbmail_mailfromemail', 'created')

        # Deleting field 'MailFromEmail.updated'
        db.delete_column('dbmail_mailfromemail', 'updated')
    ...
    models = {
        ...
        'dbmail.mailtemplate': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'from_email': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dbmail.MailFromEmail']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

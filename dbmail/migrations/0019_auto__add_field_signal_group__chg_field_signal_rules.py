...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signal.group'
        db.add_column('dbmail_signal', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbmail.MailGroup'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Signal.rules'
        db.alter_column('dbmail_signal', 'rules', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Signal.group'
        db.delete_column('dbmail_signal', 'group_id')


        # Changing field 'Signal.rules'
        db.alter_column('dbmail_signal', 'rules', self.gf('django.db.models.fields.TextField')())

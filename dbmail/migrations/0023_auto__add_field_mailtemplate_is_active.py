...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailTemplate.is_active'
        db.add_column('dbmail_mailtemplate', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailTemplate.is_active'
        db.delete_column('dbmail_mailtemplate', 'is_active')
